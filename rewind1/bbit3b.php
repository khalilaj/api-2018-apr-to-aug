...
|'We weren't meant to be somebody--we were meant to know Somebody'.PIPER,JOHN STEPHEN.2011-07-17.https://bit.ly/2r31InJ
...
//We explode the individual row data by using  '.' to get individual column data items
 $row= explode('.', $row);
  foreach ($row as $auth_column_data){
      echo $row[1]."<br />";
  }
}
  ?>
